...
import com.example.skd.myapp.receiver.AlarmReceiver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(AlarmActivity.this, "设置简单闹铃成功!", Toast.LENGTH_LONG).show();
            }
        });
        ...
        mButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                manager.setRepeating(AlarmManager.ELAPSED_REALTIME_WAKEUP,
                        firstTime, 2*1000, sender);

                Log.i(TAG, "time ==== " + time + ", selectTime ===== "
                        + selectTime + ", systemTime ==== " + systemTime + ", firstTime === " + firstTime);

                Toast.makeText(AlarmActivity.this, "设置重复闹铃成功! ", Toast.LENGTH_LONG).show();
            }
        });
