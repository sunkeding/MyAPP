...
import com.example.skd.myapp.views.ShadowProperty;
import com.example.skd.myapp.views.ShadowViewDrawable;

/**
 * Created by skd on 2017/8/29.
 */

public class ShadowHelperActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shadowhelper);
...
//                .setShadowColor(0x77000000)
                .setShadowColor(ContextCompat.getColor(this,R.color.text_color_black10))
                .setShadowDy(dip2px(this, 2f))
                .setShadowRadius(dip2px(this, 1))
