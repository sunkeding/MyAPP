...
public class CircleProgressBar extends View {
    ...
    private float mTargetPercent=50;//设置目标的百分比(也就是后台返回的数据)
    ...
    public CircleProgressBar(Context context, AttributeSet attrs) {
        ...
        //中间圆的背景颜色  默认 - 白色
        mCircleBackground = typedArray.getColor(R.styleable.PercentageRing_circleBackground, 0xff00ffff);
        //外圆环的颜色  默认 - 灰色
...
//        mArcPaint.setStrokeWidth((float) (0.075*mRadius));
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        //画中间圆
        Log.d("CircleProgressBar", "mCircleX:" + mCircleX);
        Log.d("CircleProgressBar", "mCircleY:" + mCircleY);
        Log.d("CircleProgressBar", "mRadius:" + mRadius);
...
//        roundColorPaint.setStrokeWidth((float) (0.075*mRadius));
        roundColorPaint.setStrokeWidth(50);
        canvas.drawCircle(mCircleX, mCircleY, mRadius, roundColorPaint);
        //动态绘制红色的圆环
        Log.d("CircleProgressBar", "mStartSweepValue:" + mStartSweepValue);
        Log.d("CircleProgressBar", "mCurrentAngle:" + mCurrentAngle);
        Log.d("CircleProgressBar", "mArcRectF:" + mArcRectF);
